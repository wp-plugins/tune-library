...
?>
	...
	var imageFolder = '<?php bloginfo('wpurl') ?>/wp-content/plugins/tune-library/';	// Path to images
	
	<?php $options = get_option('TuneLibraryPP');
	if ($options['iconcolor'] == "black")
	{
		echo "var plusImage = 'plusbl.gif'";
	}
	else 
	{
		echo "var plusImage = 'plusbl-white.gif'";
	...
	if ($options['iconcolor'] == "black")
	{
		echo "var minusImage = 'minusbl.gif'";
	}
	else 
	{
		echo "var minusImage = 'minusbl-white.gif'";
	...
	var ajaxRequestFile = '<?php bloginfo('wpurl') ?>/wp-content/plugins/tune-library/writeNodes.php';
